...
namespace Fias.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Age,UserName,FullName,Email,BirthDate,GraduationDate,WakeTime,IsBackendDeveloper,Salary,Avatar,RowVersion")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
